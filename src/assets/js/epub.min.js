...
var RangeObject = exports.RangeObject = function () {
	...
	_createClass(RangeObject, [{
		...
		value: function toString() {
			// To-Do: implement walking between start and end to find text
		}
	}]);
   ...
   */
		...
		value: function joinSteps(steps) {
			...
			return steps.map(function (part) {
				...
				if (part.type === "text") {
					segment += 1 + 2 * part.index; // To-Do: double check that this is odd
				}
   ...
   */
		...
		value: function fromRange(range, base, ignoreClass) {
			...
			if (range.collapsed) {
				...
				// To-Do: Add Sanity check to make sure that the end if greater than the start
			}
...
function request(url, type, withCredentials, headers) {
	var supportsURL = typeof window != "undefined" ? window.URL : false; // To-Do: fallback for url if window isn't defined
...
var Contents = function () {
   ...
   */
		...
		// To-Do: find where this is used - remove?
   ...
   */
		...
		value: function columns(width, height, columnWidth, gap) {
			...
			// To-Do: inline-block needs more testing
...
var Rendition = function () {
  ...
  */
   ...
   * @param  {string} spread none | auto (To-Do: implement landscape, portrait, both)
...
var IframeView = function () {
	...
	_createClass(IframeView, [{
		...
		value: function addListeners() {
			//To-Do: Add content listeners for expanding
		}
	}, {
		key: "removeListeners",
		value: function removeListeners(layoutFunc) {
			//To-Do: remove content listeners for expanding
		}
	}, {
		key: "display",
		...
		value: function loadNavigation(opf) {
			...
			if (toc) {
				return new Promise(function (resolve, reject) {
					...
					if (opf.pageList) {
						_this7.pageList = new _pagelist2.default(opf.pageList); // To-Do: handle page lists from Manifest
					}
  ...
  */
   ...
   */
		...
		value: function render(_request) {
			...
			this.output; // To-Do: better way to return this from hooks?
  ...
  */
   ...
   */
		...
		value: function cfiFromPage(pg) {
			...
			// To-Do: handle pages not in the list
			return cfi;
		}
...
var Annotations = function () {
  ...
  */
   ...
   * @To-Do: needs implementation in View
   */
...
var Annotation = function () {
  ...
  */
   ...
   * @To-Do: needs implementation in contents
   */
    ...
    _createClass(Underline, [{
        ...
        value: function render() {
            ...
            for (var i = 0, len = filtered.length; i < len; i++) {
                ...
                line.setAttribute('stroke', 'black'); //To-Do: match text color?
